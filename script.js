...
function create_CORDONATION_life()
    {
        cancel.top=JSON.parse(localStorage.getItem('L'))+'%';
        cancel.left=JSON.parse(localStorage.getItem('T'))+'%';
...
function  create_CORDONATION_cancel()
    {
        life.top=JSON.parse(localStorage.getItem('T'))+'%';
        life.left=JSON.parse(localStorage.getItem('L'))+'%';
